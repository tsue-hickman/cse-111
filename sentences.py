...
def main():
    """
    The main function that orchestrates the generation of sentences.
    """
...
def get_preposition():
    ...
    prepositions = [
        "about", "above", "across", "after", "along", "around", "at", "before", "behind",
        "below", "beyond", "by", "despite", "except", "for", "from", "in", "into", "near",
...
def make_sentence(quantity, tense):
    """
    Generate and print a sentence based on the given quantity and tense.
    """
    determiner = get_determiner(quantity)
    noun = get_noun(quantity)
...
def get_determiner(quantity):
    """
    Return a randomly chosen determiner based on the given quantity.
    """
    if quantity == 1:
        words = ["a", "one", "the"]
    else:
...
def get_noun(quantity):
    """
    Return a randomly chosen noun based on the given quantity.
    """
...
def get_verb(quantity, tense):
    """
    Return a randomly chosen verb based on the given quantity and tense.
    """
